...
public class ImageController {
    ...
    private String generateStepSvg(String keyword) {
        ...
        if (keyword.matches(".*(cut|chop|dice|slice|mince).*")) {
            ...
            scene = "<g transform='translate(40,15)'>"
                + "<path d='M70 65 Q68 55 75 55 L100 55 L125 55 Q132 55 130 65 L130 110 Q130 115 125 115 L75 115 Q70 115 70 110 Z' fill='#3b82f6' opacity='0.85'/>"
                + "<path d='M70 65 L55 78 L62 80 L70 72 L80 80 L88 78 L70 65' fill='#3b82f6' opacity='0.95'/>"
                + "<rect x='62' y='115' width='22' height='18' rx='3' fill='#2563eb' opacity='0.7'/>"
                + "<rect x='116' y='115' width='22' height='18' rx='3' fill='#2563eb' opacity='0.7'/>"
                + "<circle cx='99' cy='90' r='6' fill='#fff' opacity='0.4'/>"
                + "<line x1='95' y1='88' x2='103' y2='88' stroke='#fff' stroke-width='1.5' opacity='0.5'/>"
                + "<line x1='99' y1='84' x2='99' y2='92' stroke='#fff' stroke-width='1.5' opacity='0.5'/>"
                + "<rect x='140' y='100' width='35' height='50' rx='5' fill='#6b7280' opacity='0.65'/>"
                + "<rect x='148' y='145' width='20' height='7' rx='2' fill='#4b5563' opacity='0.5'/>"
                + "<text x='80' y='40' font-size='15' fill='#9d174d' font-weight='bold' text-anchor='middle'>👔 穿搭</text>"
                + "</g>";
            ...
            scene = "<g transform='translate(40,15)'>"
                + "<rect x='50' y='90' width='35' height='18' rx='6' fill='#ef4444' opacity='0.55'/>"
                + "<rect x='55' y='93' width='25' height='12' rx='3' fill='#fca5a5' opacity='0.8'/>"
                + "<rect x='92' y='88' width='35' height='20' rx='6' fill='#3b82f6' opacity='0.55'/>"
                + "<rect x='97' y='92' width='25' height='12' rx='3' fill='#93c5fd' opacity='0.8'/>"
                + "<rect x='50' y='72' width='76' height='10' rx='5' fill='#94a3b8'/>"
                + "<rect x='50' y='72' width='60' height='10' rx='5' fill='#60a5fa'/>"
                + "<circle cx='99' cy='76' r='3' fill='#fff'/>"
                + "<circle cx='118' cy='76' r='3' fill='#fff'/>"
                + "<rect x='148' y='80' width='22' height='45' rx='6' fill='#e2e8f0'/>"
                + "<rect x='153' y='88' width='12' height='30' rx='3' fill='#f1f5f9'/>"
                + "<rect x='149' y='74' width='20' height='10' rx='3' fill='#94a3b8'/>"
                + "<path d='M60 102 Q65 108 70 102 Q75 108 80 102' stroke='#f97316' stroke-width='2' fill='none' opacity='0.6'/>"
                + "<text x='80' y='40' font-size='15' fill='#166534' font-weight='bold' text-anchor='middle'>💊 健康</text>"
                + "</g>";
        } else if (keyword.matches(".*(dog|cat|pet|puppy|kitten|feed|brush|bath|walk|leash|collar|bone|treat|toy|litter|vet|groom).*")) {
            bgFrom = "#fef3c7"; bgTo = "#fde68a";
            scene = "<g transform='translate(40,15)'>"
                + "<ellipse cx='80' cy='105' rx='28' ry='22' fill='#d4a574'/>"
                + "<circle cx='80' cy='72' r='20' fill='#d4a574'/>"
                + "<ellipse cx='72' cy='66' rx='7' ry='9' fill='#c4956a'/>"
                + "<ellipse cx='88' cy='66' rx='7' ry='9' fill='#c4956a'/>"
                + "<circle cx='72' cy='66' r='3.5' fill='#333'/>"
                + "<circle cx='88' cy='66' r='3.5' fill='#333'/>"
                + "<circle cx='74' cy='68' r='1.2' fill='#fff'/>"
                + "<circle cx='90' cy='68' r='1.2' fill='#fff'/>"
                + "<ellipse cx='80' cy='85' rx='4' ry='5' fill='#333'/>"
                + "<path d='M70 80 Q74 77 78 80 L82 77 L90 80' stroke='#333' stroke-width='1.5' fill='none'/>"
                + "<path d='M92 60 Q98 54 104 60' stroke='#333' stroke-width='2.5' fill='none' stroke-linecap='round'/>"
                + "<path d='M56 105 Q50 100 46 105 Q40 98 36 105' stroke='#d4a574' stroke-width='3' fill='none' stroke-linecap='round'/>"
                + "<text x='80' y='40' font-size='15' fill='#92400e' font-weight='bold' text-anchor='middle'>🐶 宠物</text>"
                + "</g>";
        } else {
