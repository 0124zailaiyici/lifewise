...
.composer textarea {
  ...
  font: inherit; font-size: 22px; line-height: 1.3;
}
.composer textarea::placeholder { color: var(--soft); font-size: 22px; }
...
@media (max-width: 400px) {
  ...
  .composer textarea { font-size: 20px; min-height: 34px; }
  .upload-btn { font-size: 22px; }
