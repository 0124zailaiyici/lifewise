...
.composer textarea::placeholder { color: var(--soft); font-size: 20px; }
...
@media (max-width: 400px) {
  ...
  .composer textarea { font-size: 18px; min-height: 34px; }
